...
sc10x.rna.seurat.ju.all = FindVariableFeatures( object = sc10x.rna.seurat.ju.all, 
...
variablesGenesStats = paste(length( VariableFeatures( sc10x.rna.seurat.ju.all)), "/", nrow( sc10x.rna.seurat.ju.all));
...
suppressMessages(suppressWarnings(LabelPoints( plot = VariableFeaturePlot( sc10x.rna.seurat.ju.all) + theme(legend.position = "none"), 
                                               points = head( VariableFeatures( sc10x.rna.seurat.ju.all), 10), 
                                               repel = TRUE)));
...
variableAnnotationsDT = head( HVFInfo( object = sc10x.rna.seurat.ju.all, assay = "RNA", selection.method = 'vst')[VariableFeatures( sc10x.rna.seurat.ju.all),], VARIABLE_FEATURES_SHOWTOP);
