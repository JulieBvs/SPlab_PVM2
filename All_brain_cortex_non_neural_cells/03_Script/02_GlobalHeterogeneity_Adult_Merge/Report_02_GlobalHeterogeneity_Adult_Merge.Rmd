...
write.table( as.data.frame( GetAssayData(object = sc10x.rna.seurat.ad.all, slot = "counts")), file = raw_expression_file_path, quote = FALSE, col.names = TRUE, row.names = TRUE, sep=",")
...
write.table( as.data.frame( GetAssayData(object = sc10x.rna.seurat.ad.all, slot = "data")), file = normalized_expression_file_path, quote = FALSE, col.names = TRUE, row.names = TRUE, sep=",")

cat("<BR><BR>Exporting Rdata to files:<BR>")

# Exporting Seurat object
seurat_object_file_path = file.path( PATH_ANALYSIS_OUTPUT, paste0( outputFilesPrefix, "QCfiltered_sc10x.rna.seurat.ad.all.RDS"))

cat("<BR>* Seurat Object:<BR>", seurat_object_file_path)
saveRDS( object = sc10x.rna.seurat.ad.all, file = seurat_object_file_path)


seurat_object_subset_file_path = file.path( PATH_ANALYSIS_OUTPUT, paste0( outputFilesPrefix, "QCfiltered_subset_sc10x.rna.seurat.ad.all.RDS"))

cat("<BR>* Seurat Object:<BR>", seurat_object_subset_file_path)
saveRDS( object = sc10x.rna.seurat.ad.subset, file = seurat_object_subset_file_path)
...
write.table( Embeddings( sc10x.rna.seurat.ad.all, reduction = "pca"), file = PCA_map_file_path, quote = FALSE, col.names = TRUE, row.names = TRUE, sep=",")
...
write.table( Embeddings( sc10x.rna.seurat.ad.all, reduction = "tsne"), file = tsne_map_file_path, quote = FALSE, col.names = TRUE, row.names = TRUE, sep=",")
...
write.table( Embeddings( sc10x.rna.seurat.ad.all, reduction = "umap"), file = umap_map_file_path, quote = FALSE, col.names = TRUE, row.names = TRUE, sep=",")
...
write.table( data.frame( Idents( sc10x.rna.seurat.ad.all)), file = seurat_clusters_file_path, quote = FALSE, col.names = TRUE, row.names = TRUE, sep=",")
