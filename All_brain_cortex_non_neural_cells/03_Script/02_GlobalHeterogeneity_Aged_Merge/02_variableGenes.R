...
sc10x.rna.seurat.ag.all = FindVariableFeatures( object = sc10x.rna.seurat.ag.all, 
...
variablesGenesStats = paste(length( VariableFeatures( sc10x.rna.seurat.ag.all)), "/", nrow( sc10x.rna.seurat.ag.all));
...
suppressMessages(suppressWarnings(LabelPoints( plot = VariableFeaturePlot( sc10x.rna.seurat.ag.all) + theme(legend.position = "none"), 
                                               points = head( VariableFeatures( sc10x.rna.seurat.ag.all), 10), 
                                               repel = TRUE)));
...
variableAnnotationsDT = head( HVFInfo( object = sc10x.rna.seurat.ag.all, assay = "RNA", selection.method = 'vst')[VariableFeatures( sc10x.rna.seurat.ag.all),], VARIABLE_FEATURES_SHOWTOP);
