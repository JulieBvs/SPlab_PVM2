...
ANALYSIS_STEP_NAME = "05_Lyve1_Cluster_From_Sample_Integration"
PATH_ANALYSIS_OUTPUT = file.path( PATH_PROJECT_OUTPUT, ANALYSIS_STEP_NAME)

PATH_SEURAT_INTEGRATION = file.path( PATH_PROJECT_OUTPUT, "04_Sample_Integration", paste0( outputFilesPrefix, "sc10x.rna.seurat.integrated.RDS"))
PATH_CELL_BC_CLUSTER_LYVE1 = file.path( PATH_PROJECT_OUTPUT, "04_Sample_Integration", paste0( outputFilesPrefix, "barcodes_cells_from_cl_interest_7.txt"))
